    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow container mx-auto px-4 py-8">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mt-8 text-center">
                    <button onclick="testAPI()" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200">
                        <i class="fas fa-play mr-2"></i>Test API Connection
                    </button>
                </div>
            </div>
        </main>
        ...
        <footer class="bg-gray-800 text-white py-4 mt-8">
            <div class="container mx-auto px-4 text-center">
                <p class="text-sm">© 2024 ECR Wings Academy. All rights reserved.</p>
            </div>
        </footer>
    </div>
